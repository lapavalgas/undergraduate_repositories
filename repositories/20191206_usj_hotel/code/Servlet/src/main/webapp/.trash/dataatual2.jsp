		...
		<section class="main">
			...
			<div class="rooms">
				...
				<c:forEach var="i" begin="1" end="5">
					...
					<c:if test="${not empty list[i]}">
						<ul class="list-group list-group-horizontal">
							...
							<form action="ReservaController"></form>
							...
							<li class="list-group-item flex-fill" style="width: 157px;">
								<input type="text" class="form-control" placeholder="" value="${list[i].preco}"
									disabled>
							</li>
							<li class="list-group-item" style="border: none;">
								<input class="btn btn-danger btn-lg" style="width: 208px;" type="button"
									value="Cancelar">
								</form>
							</li>
						</ul>
					...
					<c:if test="${empty list[i]}">
						<ul class="list-group list-group-horizontal">
							...
							<li class="list-group-item flex-fill" style="width: 157px;">
								<input type="text" class="form-control" placeholder="Ex.:   R$ 127,48" value="">
							</li>
							<li class="list-group-item" style="border: none;">
								<input class="btn btn-success btn-lg" style="width: 208px;" type="button"
									value="Reservar">
								</form>
							</li>
						</ul>
				...
				<ul class="list-group list-group-horizontal">
						...
						<li class="list-group-item flex-fill ">
							<h4 style="text-align: right;">ROOM: 01</h4>
						</li>
	
						<form action=""></form>
	
						<li class="list-group-item flex-fill " style="width: 313px;">
							<input type="text" class="form-control" value="Rafael Lapa Valgas" style="margin-bottom: 5px;"
								disabled>
							<input type="text" class="form-control" id="hospedeCpf" placeholder="Ex.:   xxx.xxx.xxx-xx"
								autocomplete="off" name="customer['cpf']" oninput="mascara(this, 'cpf')" disabled>
						</li>
						...
						<li class="list-group-item flex-fill" style="width: 157px;">
							<input type="text" class="form-control" placeholder="Ex.:   R$ 1000,50" value="1000,50"
								disabled>
						</li>
	
						<li class="list-group-item" style="border: none;">
							<input class="btn btn-danger btn-lg" style="width: 208px;" type="button" value="Cancelar">
							</form>
						</li>
					...
					<ul class="list-group list-group-horizontal">
						<li class="list-group-item flex-fill ">
							<h4 style="text-align: right;">ROOM: 02</h4>
						</li>
						<form action=""></form>
						<li class="list-group-item flex-fill " style="width: 313px;">
							<input type="text" class="form-control" placeholder="Nome do hospede" value=""
								style="margin-bottom: 5px;" disabled>
							<input type="text" class="form-control" id="hospedeCpf" placeholder="Ex.:   xxx.xxx.xxx-xx"
								autocomplete="off" name="customer['cpf']" oninput="mascara(this, 'cpf')">
						</li>
						<!-- VERIFICAR SE EXISTE RESERVA -->
						<!-- VERIFICAR SE EXISTE RESERVA -->
						<li class="list-group-item flex-fill" style="width: 157px;">
							<input type="text" class="form-control" placeholder="Ex.:   R$ 1000,50" value="">
						</li>
						<li class="list-group-item" style="border: none;">
							<input class="btn btn-success btn-lg" style="width: 208px;" type="button" value="Reservar">
							</form>
						</li>
						<!-- VERIFICAR SE EXISTE RESERVA -->
						<!-- VERIFICAR SE EXISTE RESERVA -->
					...
					<ul class="list-group list-group-horizontal">
						<li class="list-group-item flex-fill ">
							<h4 style="text-align: right;">ROOM: 03</h4>
						</li>
						<form action=""></form>
						<li class="list-group-item flex-fill " style="width: 313px;">
							<input type="text" class="form-control" placeholder="Nome do hospede" value=""
					...
					<ul class="list-group list-group-horizontal">
						<li class="list-group-item flex-fill ">
							<h4 style="text-align: right;">ROOM: 04</h4>
						</li>
						<form action=""></form>
						<li class="list-group-item flex-fill " style="width: 313px;">
							<input type="text" class="form-control" placeholder="Nome do hospede" value=""
					...
					<ul class="list-group list-group-horizontal">
						<li class="list-group-item flex-fill ">
							<h4 style="text-align: right;">ROOM: 05</h4>
						</li>
						<form action=""></form>
						<li class="list-group-item flex-fill " style="width: 313px;">
							<input type="text" class="form-control" placeholder="Nome do hospede" value=""

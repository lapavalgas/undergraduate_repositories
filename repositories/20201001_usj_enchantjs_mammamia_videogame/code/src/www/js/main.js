...
var SceneGame = Class.create(Scene, {
    ...
    setScore: function (value) {
        this.score = value;
        this.scoreLabel.text = 'PIZZAS<br>' + this.score;
    }
});
...
var SceneGameOver = Class.create(Scene, {
    initialize: function (score) {
        ...
        gameOverLabel = new Label("L'italiano<br><br>Tocca per riavviare<br><br><br>Rafael Lapa Valgas");
        gameOverLabel.x = 8;
        gameOverLabel.y = 128;
        ...
        scoreLabel = new Label('PIZZAS<br>' + score);
        scoreLabel.x = 9;
        scoreLabel.y = 32;

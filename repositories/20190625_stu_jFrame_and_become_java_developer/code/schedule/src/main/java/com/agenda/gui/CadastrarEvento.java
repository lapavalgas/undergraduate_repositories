...
import static com.agenda.gui.AgendaApp.reloadModel;
import com.agenda.sistema.Sistema;

public class CadastrarEvento extends javax.swing.JFrame {

    private boolean titleKey = false, resumoKey = false;
    ...
    private void initComponents() {
        ...
        jTextField1.setText("  N O M E   D A   T A R E F A");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        novoEvento.CcadastraEvento(
                jTextField1.getText(), 
                jTextArea1.getText());
        cadastrarEvento.createEvent(novoEvento, Sistema.getId());
        Sistema.setAgenda();
